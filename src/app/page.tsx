...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900 selection:bg-red-600 selection:text-white">
      ...
      <div className="bg-[#b91c1c] text-white text-xs py-1.5 px-4 sm:px-8 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center space-x-3 text-[11px]">
          <a href="#loans" className="hover:underline font-semibold hidden sm:inline">Loans</a>
          <a href="#calculator" className="hover:underline font-semibold hidden sm:inline">EMI Calculator</a>
          <a href="#schemes" className="hover:underline font-semibold hidden sm:inline">FD Schemes</a>
      ...
      <header className="bg-[#003366] text-white py-4 px-6 sm:px-12 border-b-4 border-red-600 shadow-lg sticky top-0 z-40">
        <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center space-x-6 text-xs font-bold text-slate-100">
            <a href="#hero" className="hover:text-red-400 transition">NetBanking Login</a>
            <a href="#loans" className="hover:text-red-400 transition">Loans & Mortgages</a>
            <a href="#calculator" className="hover:text-red-400 transition">EMI Calculator</a>
            <a href="#schemes" className="hover:text-red-400 transition">FD & Schemes</a>
            <a href="#branches" className="hover:text-red-400 transition">Branch Locator</a>
            <a href="#app" className="hover:text-red-400 transition">Mobile App</a>
          </nav>

          <div className="flex items-center space-x-3">
            <a
              href="#hero"
              className="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg text-xs font-bold shadow transition flex items-center gap-1.5"
            >
      ...
      <section id="loans" className="py-12 px-4 sm:px-6 max-w-7xl mx-auto w-full space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm space-y-4 hover:border-blue-400 transition group">
            ...
            <button onClick={() => router.push('/dashboard')} className="text-xs font-extrabold text-blue-700 group-hover:text-red-600 flex items-center gap-1 transition">
              Apply Now &rarr;
            </button>
          </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-md flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="space-y-4 max-w-xl">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <button onClick={() => router.push('/dashboard')} className="bg-[#003366] text-white px-5 py-2.5 rounded-xl text-xs font-bold flex items-center space-x-2 shadow hover:bg-[#002244] transition">
